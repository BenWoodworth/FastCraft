...
class BukkitFcGuiFactory_1_8_R01 @Inject constructor(
    private val server: Server,
    private val textConverter: FcTextConverter,
    private val guiFactory: BukkitFcGui_1_8_R01Factory,
    private val guiLayoutGridFactory: BukkitFcGuiLayoutGrid_1_8_R01Factory
) : BukkitFcGuiFactory {
