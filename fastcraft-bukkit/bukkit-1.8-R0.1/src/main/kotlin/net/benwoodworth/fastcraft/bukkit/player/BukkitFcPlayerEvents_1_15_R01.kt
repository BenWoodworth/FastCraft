...
class BukkitFcPlayerEvents_1_15_R01 @Inject constructor(
    plugin: Plugin,
    ...
    private inner class EventListener : Listener {
        ...
        fun onPlayerJoin(event: PlayerJoinEvent) {
            onPlayerJoin.notifyHandlers(
                BukkitFcPlayerJoinEvent_1_15_R01(event, playerProvider)
            )
        }
        ...
        fun onPlayerInteract(event: PlayerInteractEvent) {
            ...
            onPlayerOpenWorkbench.notifyHandlers(
                BukkitFcPlayerOpenWorkbenchEvent_1_15_R01(event, playerProvider)
            )
        }
    }
}
